...
public class LTetromino implements Tetromino {
    ...
    public LTetromino(){
        this.color = new java.awt.Color(172, 97, 43);
        try{
            File path = new File("C:\\Users\\Remco\\Documents\\IdeaProjects\\TMCProjects\\2017_avans_ti_breda-2D_Graphics-2019\\Tetris\\Recources\\lPiece.png");
        ...
        this.rotation = 0;
        this.pointBlock1 = new Point2D(4, 0);
        this.pointBlock2 = new Point2D(5, 0);
        this.pointBlock3 = new Point2D(6, 0);
        this.pointBlock4 = new Point2D(6, -1);
